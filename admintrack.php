...
<head>
  ...
  <meta name="description"
    content="Rapid Express Agency Delivery Limited - We Deal With your Logistics & Shipping Needs!">
  ...
  <title>Tracking Details - UPS Global Shipping And Logistics Solutions</title>
...
<body>
  ...
  <header class="header header-style-02 header-sticky">
    <div class="topbar">
      <div class="container">
        <div class="row">
          <div class="col-lg-6 d-flex justify-content-center justify-content-lg-start email-wrap">
            <a href="#">contact@upsglobalshippingandlogisticssolutions.online</a>
          </div>
          ...
          <div class="container-fluid position-relative px-0">
            ...
            <div class="navbar-collapse collapse d-xl-flex justify-content-xl-center pl-0 pl-lg-5">
              <ul class="nav navbar-nav">
                <li class="nav-item">
                  <a class="nav-link" href="index.html" id="" role="" data-toggle="" aria-haspopup=""
                    aria-expanded="">Home<i class=""></i></a>
                </li>
  ...
  <!--Page Header-->
  <section class="inner-header bg-holder bg-overlay-dark-40"
    style="background-image: url('images/service/airterminal2.jpg');">
    <div class="container">
      <div class="row">
        <div class="col-md-6">
    ...
    <div class="container">
      ...
      if (isset($_SESSION['track']) && $_SESSION['track'] !== null) {
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <b>Welcome,</b> | <a href="/"> Back to Homepage </a>
          </div>
            ...
            <table class="table table-striped table-bordered table-condensed">
              <tbody>
                ...
                <tr>
                  ...
                  ?>
                  <td class="text-center"><b>Current Location <img src="../loading.gif" style="height: 30px; width: 50px">
                    </b></td>
                  <td class="col-xs-6">
                    <marquee>
                      <?php echo $data['current_location'] == "" ? $data['dispatch_location'] : $data['current_location'] ?>
                      &nbsp;
                    </marquee>
                  </td>
                </tr>
          ...
          <table class="table table-striped table-bordered table-condensed">
            <tbody>
              <iframe class="map"
                src="https://maps.google.com/maps?q=<?php echo $data['current_location'] == "" ? $data['dispatch_location'] : $data['current_location'] ?>&amp;t=k&amp;z=13&amp;ie=UTF8&amp;iwloc=&amp;output=embed"
                style="border:0; width: 100%; height: 527px;"></iframe>
            </tbody>
          </table>
          <!-- <div class="row">
          ...
          <center><a href="../receipt.php?tnum=<?php echo $data['tracking_number'] ?>" class="btn btn-primary">Print
              Receipt</a></center>
        ...
        <form action="" method="post" style="margin bottom:50px">
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"
              placeholder="Enter Tracking Code" name="tnumber" value=""
              style="width:350px; background-color: lightgrey">
          </div>
        ...
        <div class="col-sm-6 col-lg-3 order-lg-1 mb-5 mb-lg-0">
          ...
          <ul class="footer-contact list-unstyled">
            ...
            <li>
              ...
              <div class="footer-contact-info">
                <!-- <a href="https://wa.me/+447376329880">
                  <style="image src: url(images/whatsap.png)" <span>+44 7376 329880
                    </span>
                </a> -->
            ...
            <li>
              ...
              <div class="footer-contact-info">
                <span>contact@upsglobalshippingandlogisticssolutions.online</span>
      ...
      <div class="copyright">
        <div class="row d-flex align-items-center">
          ...
          <div class="col-md-6 text-left text-md-right mt-4 mt-md-0">
            <p class="mb-0 text-white">©️ 2025. All rights reserved.</p>
          </div>
        </div>
      </div>
    </div>
