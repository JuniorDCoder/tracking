...
<head>
  ...
  <meta name="description"
    content="UPS Global Shipping And Logistics Solutions Delivery Limited - We Deal With your Logistics & Shipping Needs!">
          ...
          <div class="container-fluid position-relative px-0">
            ...
            <div class="navbar-collapse collapse d-xl-flex justify-content-xl-center pl-0 pl-lg-5">
              <ul class="nav navbar-nav">
                <li class="nav-item">
                  <a class="nav-link" href="/" id="" role="" data-toggle="" aria-haspopup="" aria-expanded="">Home<i
                      class=""></i></a>
                  <!--
...
-->
                ...
                <li class="dropdown nav-item" style="text-decoration-color: darkblue">
                  <a class="nav-link" href="javascript:void(0)" data-toggle="dropdown">Service<i
      ...
      if (isset($_SESSION['track']) && $_SESSION['track'] !== null) {
        ...
        <div class="row">
          ...
          <div class="col-md-12 col-md-offset-0">
            ...
            <table class="table table-striped table-bordered table-condensed">
              ...
              <tbody>
                ...
                <tr>
                  <td class="text-right"><b>Current Location <IMG SRC="loading.gif" style="height: 30px; width: 50px">
                    </b></td>
                  <td class="col-xs-6">
                    <marquee>
          ...
          <table class="table table-striped table-bordered table-condensed">
            <tbody>
              <iframe class="map"
                src="https://maps.google.com/maps?q=Mount%20Pleasant,%20Breach%20Lane,%20Sittingbourne,%20ME9%207DB&amp;t=k&amp;z=13&amp;ie=UTF8&amp;iwloc=&amp;output=embed"
        ...
        <div class="col-sm-6 col-lg-3 order-lg-1 mb-5 mb-lg-0">
          ...
          <ul class="footer-contact list-unstyled">
            ...
            <li>
              ...
              <div class="footer-contact-info">
                <!-- <a href="https://wa.me/16137633838">
                  <style="image src: url(images/whatsap.png)" <span>+1 (613) 763-3838
                    </span>
                </a> -->
            ...
            <li>
              ...
              <div class="footer-contact-info email-wrap">
      ...
      <div class="copyright">
        <div class="row d-flex align-items-center">
          ...
          <div class="col-md-6 text-left text-md-right mt-4 mt-md-0">
            <p class="mb-0 text-white">©️ 2025 UPS Global Shipping And Logistics Solutions. All rights reserved.</p>
          </div>
        </div>
      </div>
    </div>
